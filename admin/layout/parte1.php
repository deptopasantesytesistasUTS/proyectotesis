...
//Seguridad para que no se pueda acceder al login por la barra del navegador
if(isset($_SESSION['sesion email'])){
  ...
  foreach ($sesion_usuarios as $sesion_usuarios) {
    $nombre_sesion = $sesion_usuarios['nombres'];
  }
}else{
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=APP_URL;?>/admin" class="brand-link">
      <!--Siguiente srh para la imagen del UTS-->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
      <!-- Siguiente srh para la imagen del usuario ingresado -->
          <img src="<?=APP_URL;?>/public/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block" style="white-space: normal; word-break: break-word; line-height: 1.2;"><?=$nombre_sesion;?></a>
        </div>
      </div>
